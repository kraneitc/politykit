...
The built-in `fake` provider is local and deterministic for examples and tests. It can generate advisory run-summary artifacts and scenario suggestion drafts without sending run data outside the process.
